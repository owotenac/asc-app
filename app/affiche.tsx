                ...
                <GestureHandlerRootView  >
                    ...
                    >
                        ...
                        <View style={global_styles.left_box}>
                            <Text style={global_styles.text_vertical}>AFFICHE DU WEEKEND</Text>
                        </View>
                        {
                            loading ? (
                                ...
                                match.map((m, index) => (
                                    <React.Fragment key={index}>
                                        ...
                                        <MovableView initialPosition={80}>
                                            <AfficheCard matchesData={m} ></AfficheCard>
                                        </MovableView>
                                        <MovableView initialPosition={(screenWidth / 0.8) - 50}>
                                            <View style={styles.date}>
                                                <Text style={styles.text_date}>{m.DisplayDate}</Text>
                                                <Text style={styles.text_date}>{m.Time}</Text>
                                            </View>
                                        </MovableView>
                                    </React.Fragment>
                                ))
